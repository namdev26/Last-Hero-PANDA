...
public class WaterReflectionEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            EditorGUILayout.HelpBox("You must assign the _camera.", MessageType.Error);
        }
        else
        {
            waterReflection.verticalCameraOffset = EditorGUILayout.FloatField(new GUIContent("Vertical Camera Offset", "By default, the _camera used to capture the reflection's scene is placed just above the sprite renderer. You can adjust _camera height by modifying this offset."), waterReflection.verticalCameraOffset);
        }
