...
public class WaterReflection : MonoBehaviour
{
    ...
    public void Awake()
    {
        // Unity modify _camera's aspect when game starts (according to your screen dimensions). So we call UpdateCamera here to override it.
        UpdateCamera();
    }

    public void UpdateCamera()
    {
        if (spriteRenderer != null && _camera != null && waterShader != null)
        {
            ...
            _camera.aspect = spriteRenderer.bounds.size.x / cameraHeight;
            _camera.orthographicSize = verticalSqueezeRatio * spriteRenderer.bounds.size.y / 2;
